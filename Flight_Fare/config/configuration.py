...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            download_dir = os.path.join(
                data_ingestion_artifact_dir,
                data_ingestion_info[DATA_INGESTION_DATASET_DIR_KEY]
            )
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            report_dir = os.path.join(data_validation_artifact_dir,
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transformation_artifact_dir=os.path.join(
                artifact_dir,
                DATA_TRANSFORMATION_ARTIFACT_DI_KEY,
                self.time_stamp
            )

            data_transformation_config_info=self.config_info[DATA_TRANSFOMATION_CONFIG_KEY]
            ...
            data_transformation_artifact_dir,
            data_transformation_config_info[DATA_TRANSFORMATION_TRANSFORMD_DIR_KEY],
