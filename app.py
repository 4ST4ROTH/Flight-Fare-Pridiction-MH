...
from Flight_Fare.entity.fare_predictor import flightData , FarePredictor
...
FLIGHT_DATA_KEY = "Flight_Fare_data"
PRICE_KEY = "Price"
...
def predict():
    ...
    if request.method == 'POST':
        ...
        premium_df = Flight_fare_data.get_fares_input_data_frame
        premium_predictor = FarePredictor(model_dir=MODEL_DIR)
        Price = premium_predictor.predict(X=premium_df)
        context = {
            FLIGHT_DATA_KEY: flightData.get_fare_data_as_dict(),
            PRICE_KEY: Price,
        }
